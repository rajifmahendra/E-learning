...
@section('content')
<div class="container" style="margin-bottom:23%;">
  @if (session('status'))
      <div class="alert alert-success">
          {{ session('status') }}
      </div>
  @endif
  <h1 class="text-primary"><b>Daftar Murid Kelas {{ $data_kelas->kelas}}</b></h1><br>
  <p>
    <a class="btn btn-success fa fa-undo" href="{{ url('/kelas') }}" role="button"> Back</a>
