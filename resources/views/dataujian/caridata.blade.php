...
<div class="card">
  ...
  <p>
  <form action="/cari/guru" method="POST" class="form-inline" style="margin-left:2%; margin-top:15px;">
      @csrf
    ...
    <tr>
      ...
      <td>
        <form action="{{ url('/dataujian', $value->id) }}" method="POST">
          <a href="{{ url('/dataujian/'.$value->id)}}" class="btn btn-sm btn-primary fa fa-check"> Pilih</a>
        </form>
      </td>
    </tr>
    @endforeach
