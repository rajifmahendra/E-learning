...
<div class="container">
    ...
    <p>
      <a class="btn btn-success fa fa-undo" href="{{ url('/tampilnilai/'. $ujian_murid->data_ujian->id) }}" style="border-radius:5px;" role="button"> Back</a>
    </p>
  <form class="form-horizontal" method="POST" action="{{ url('/tampiljawaban/{id}') }}">
